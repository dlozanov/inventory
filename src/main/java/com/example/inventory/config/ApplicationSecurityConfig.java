...
import com.example.inventory.service.impl.InventoryUserService;
...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public ApplicationSecurityConfig(InventoryUserService inventoryUserService, PasswordEncoder passwordEncoder) {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.
                authorizeRequests().
                        ...
                        antMatchers("/", "/users/login", "/users/register", "/firms/items/api/*").permitAll().
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.
                userDetailsService(inventoryUserService).
